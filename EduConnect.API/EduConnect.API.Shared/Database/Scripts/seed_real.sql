...
BEGIN TRY
    ...
    IF NOT EXISTS (SELECT 1 FROM Cursos WHERE Nome = 'Analise e Desenvolvimento de Sistemas' AND DepartamentoId = @DepartamentoId)
        INSERT INTO Cursos (Nome, DepartamentoId) VALUES ('Analise e Desenvolvimento de Sistemas', @DepartamentoId);

    IF NOT EXISTS (SELECT 1 FROM Cursos WHERE Nome = 'Sistemas de Informacao' AND DepartamentoId = @DepartamentoId)
        INSERT INTO Cursos (Nome, DepartamentoId) VALUES ('Sistemas de Informacao', @DepartamentoId);

    IF NOT EXISTS (SELECT 1 FROM Cursos WHERE Nome = 'Ciencia da Computacao' AND DepartamentoId = @DepartamentoId)
        INSERT INTO Cursos (Nome, DepartamentoId) VALUES ('Ciencia da Computacao', @DepartamentoId);
    ...
    DECLARE @CursoADS INT = (SELECT TOP 1 Id FROM Cursos WHERE Nome = 'Analise e Desenvolvimento de Sistemas');
    DECLARE @CursoSI INT = (SELECT TOP 1 Id FROM Cursos WHERE Nome = 'Sistemas de Informacao');
    DECLARE @CursoCCO INT = (SELECT TOP 1 Id FROM Cursos WHERE Nome = 'Ciencia da Computacao');
